...
export function unaryKeyName(op: OpUnary_Operator): string {
    switch (op) {
...
export function binaryKeyName(op: OpBinary_Operator): string {
    switch (op) {
...
export function variadicKeyName(op: OpVariadic_Operator): string {
    switch (op) {
